...
public final class ResourceInstaller {
    ...
    private static final List<String> DEFAULT_RESOURCES = List.of(
            ...
            "gui/de/plot-profile.yml",
            "gui/de/plot-warps.yml",
            "gui/de/plot-homes.yml",
            "gui/de/plot-search.yml",
            "gui/de/top-plots.yml",
            "gui/de/cleanup.yml",
            "gui/de/guestbook.yml",
            "gui/de/mailbox.yml",
            "gui/de/requests.yml",
            "gui/de/competitions.yml",
            "gui/de/team-requests.yml",
            "gui/de/reports.yml",
            "gui/de/build-tasks.yml",
            "gui/de/permission-check.yml",
            "gui/de/performance.yml",
            "gui/de/team-moderation.yml",
            ...
            "gui/de-bedrock/cleanup.yml",
            "gui/de-bedrock/competitions.yml",
            ...
            "gui/de-bedrock/temporary-trusts.yml",
            "gui/de-bedrock/performance.yml",
            "gui/de-bedrock/permission-check.yml",
            "gui/de-bedrock/plot-dashboard.yml",
            "gui/de-bedrock/plot-profile.yml",
            "gui/de-bedrock/plot-search.yml",
            "gui/de-bedrock/plot-tools.yml",
            "gui/de-bedrock/plot-warps.yml",
            "gui/de-bedrock/plot-homes.yml",
            "gui/de-bedrock/top-plots.yml",
            "gui/de-bedrock/mailbox.yml",
            ...
            "gui/en-bedrock/cleanup.yml",
            "gui/en-bedrock/competitions.yml",
            ...
            "gui/en-bedrock/temporary-trusts.yml",
            "gui/en-bedrock/performance.yml",
            "gui/en-bedrock/permission-check.yml",
            "gui/en-bedrock/plot-dashboard.yml",
            "gui/en-bedrock/plot-profile.yml",
            "gui/en-bedrock/plot-search.yml",
            "gui/en-bedrock/plot-tools.yml",
            "gui/en-bedrock/plot-warps.yml",
            "gui/en-bedrock/plot-homes.yml",
            "gui/en-bedrock/top-plots.yml",
            "gui/en-bedrock/mailbox.yml",
            ...
            "gui/en-bedrock/team-moderation.yml",
